...
export function MenuBar({
  ...
  return (
    <div
      className={` flex gap-2 bg-black/25 backdrop-blur-sm border border-white/50 shadow-[inset_0_1px_0px_rgba(255,255,255,0.75),0_0_9px_rgba(0,0,0,0.2),0_3px_8px_rgba(0,0,0,0.15)] p-3 text-white relative rounded-3xl before:rounded-3xl after:rounded-3xl
